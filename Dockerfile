...
RUN comfy model download --url https://huggingface.co/Kim2091/AnimeSharp/blob/main/4x-AnimeSharp.pth --relative-path models/upscale_models --filename 4x-AnimeSharp.pth
